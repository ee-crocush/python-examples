...
6. [Алгоритмы сортировки](base/algoritms.md)

## 2. Python +

1. [Управление памятью](base_deep/memory.md)
2. [Дескрипторы](base_deep/descriptor.md)
3. [Асинхронность](base_deep/async.md)

## 3. ООП, архитектура и паттерны

1. [ООП](oop/oop.md)
2. [Датаклассы](oop/data_classes.md)
3. [Паттерны](oop/patterns.md)
4. [Архитектура](oop/architecture.md)

## 4. БД

1. [Все о БД](bd/sql) - NoSQL и колоночные бд в разработке
...
1. [Devops/Инфраструктура](devops/devops.md)
